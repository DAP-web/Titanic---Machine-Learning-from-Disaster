...
Original file is located at
    https://colab.research.google.com/drive/1VcuETvBXi6AefHPe0kSuca_y7b673Srq
...
1.   How to do some basic pre-processing. For example, the passenger names will be
tokenized, and ticket names will be splitted in parts.
...
def prediction_to_kaggle_format(model, threshold=0.5):
    proba_survive = tuned_model.predict(serving_ds, verbose=0)[:,0] #cambiar tuned_model por model si se desea ver el normal
    return pd.DataFrame({
